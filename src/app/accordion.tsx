...
const Accordion = () => {
  ...
  return (
    <div className="accordion-container">
        <h2 className="cursor-pointer bg-gray-500 hover:bg-grey-700 text-white font-bold py-1 px-4 my-1 rounded">Generales </h2>
        <p className="hidden">TOYOTA, 4 RUNNER Limited, 2005, V8 – 4.7, Automática, 4X2. Precio: $ 160,000 pesos.</p>
        <h2 className="cursor-pointer bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-4 my-1 rounded">Legal</h2>
        ...
        <h2 className="cursor-pointer bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-4 my-1 rounded"> Comodidades </h2>
        ...
        <h2 className="cursor-pointer bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-4 my-1 rounded">Seguridad </h2>
        ...
        <h2 className="cursor-pointer bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-4 my-1 rounded">Suspensión </h2>
        ...
        <h2 className="cursor-pointer bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-4 my-1 rounded">Transmisión </h2>
        <p className="hidden">Sin ningún tema, se le hace servicio preventivo cada año.</p>
        <h2 className="cursor-pointer bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-4 my-1 rounded">Ventajas adicionales que quizás no encuentres en otro vehículo </h2>
        ...
        <h2 className="cursor-pointer bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-4 my-1 rounded">Detalles estéticos </h2>
        ...
        <h2 className="cursor-pointer bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-4 my-1 rounded">Detalles mecánicos </h2>
        <p className="hidden">Ninguno, tu mecánico es bienvenido a revisar la unidad.</p>
        <h2 className="cursor-pointer bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-4 my-1 rounded">Detalles generales simples </h2>
        <p className="hidden">El botón para bajar la ventana del copiloto no siempre funciona.</p>
        <h2 className="cursor-pointer bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-4 my-1 rounded">Contacto </h2>
